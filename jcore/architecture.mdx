...
<Frame caption="The JIA logical stack">
  <img src="/images/jcore/stack-diagram.png" alt="The JIA logical stack: perception, context and understanding, reasoning, and execution and control layers, connected by a local VA network, a storage module and a dialog management module, above an infrastructure layer." />
</Frame>
